...
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/bypassC
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/bypassD
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/raA
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/raB
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/idex_rs
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/idex_rt
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/exmem_rd
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/memwb_rd
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/exmem_regwrite
add wave -noupdate -group bypass_branch -radix hexadecimal /cpu_tb/cpu0/bypass_branch/memwb_regwrite
add wave -noupdate -expand -group IDEX -color {Blue Violet} -radix hexadecimal /cpu_tb/clock
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/cpu_regs/data
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_ALUSrc
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_ALUcntrl
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_Branch
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_MemRead
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_MemToReg
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_MemWrite
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_RegDst
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_RegWrite
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_instr_rd
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_instr_rs
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_instr_rt
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/rdA
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_rdA
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/rdB
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_rdB
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/instr_sh
add wave -noupdate -expand -group IDEX -radix hexadecimal /cpu_tb/cpu0/IDEX_Shamt
...
add wave -noupdate -expand -group {STAII UNIT} -color {Blue Violet} -radix hexadecimal /cpu_tb/clock
add wave -noupdate -expand -group {STAII UNIT} -radix hexadecimal /cpu_tb/cpu0/stall
add wave -noupdate -expand -group {STAII UNIT} -radix hexadecimal /cpu_tb/cpu0/ifid_write
add wave -noupdate -expand -group {STAII UNIT} -radix hexadecimal /cpu_tb/cpu0/pc_write
add wave -noupdate -expand -group {STAII UNIT} -radix hexadecimal /cpu_tb/cpu0/control_stall/bubble_idex
add wave -noupdate -expand -group ALU -color {Blue Violet} -radix hexadecimal /cpu_tb/clock
add wave -noupdate -expand -group ALU -radix hexadecimal /cpu_tb/cpu0/ALUInA
add wave -noupdate -expand -group ALU -radix hexadecimal /cpu_tb/cpu0/ALUInB
add wave -noupdate -expand -group ALU -radix hexadecimal /cpu_tb/cpu0/ALUOp
add wave -noupdate -expand -group ALU -radix hexadecimal /cpu_tb/cpu0/ALUOut
add wave -noupdate -expand -group ALU -radix hexadecimal /cpu_tb/cpu0/Zero
add wave -noupdate -expand -group ALU -radix hexadecimal /cpu_tb/cpu0/IDEX_Shamt
...
WaveRestoreCursors {{Cursor 1} {15655 ps} 0}
